...
void call(Isolate* isolate, string input) {
    ...
    Handle<String> source = String::Concat(String::Concat(String::NewFromUtf8(isolate, "function __call() { return "), function_name), String::NewFromUtf8(isolate, ".apply(null, arguments); }"));
    Handle<Script> script = Script::Compile(source);
